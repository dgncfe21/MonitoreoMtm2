...
var cars_Ref = firebase.database().ref('/LAMPARAS_E2_MAT');


var dataConductores = firebase.database().ref('/LAMPARAS_E2_MAT');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E2_MAT');
